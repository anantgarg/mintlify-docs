...
description: "**Conversation Starter** enables you to retrieve an initial message in a new conversation, often used to set the context for the conversation that is about to begin. This can be particularly useful for guiding users on how to interact within the chat or for delivering automated messages that engage users when they initiate a chat."
---
...
<Steps>
<Step>
Set up the AI settings through the CometChat dashboard as detailed in the [Overview section](https://www.cometchat.com/docs/fundamentals/ai-user-copilot/ai-user-copilot/overview).
</Step>
<Step>
Navigate to Chat <Icon icon="angle-right" iconType="solid"/> Features, under **AI User Copilot**, enable **Conversation Starter**.
<Frame>
	![Image](https://www.cometchat.com/docs/assets/images/cometchat-ai-features-conversation-starter-3a48939de0ec4d575fb5c788552da0a2.png)
</Frame>
</Step>
<Step>
Implement the chat functionality in your applications using [CometChat's **v4** Chat SDKs](https://www.cometchat.com/docs/sdk/javascript/overview).
</Step>
</Steps>
...
<CodeGroup>
```javascript JS/React Native/Ionic SDK
